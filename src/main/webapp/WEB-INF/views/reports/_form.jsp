...
<label for="${AttributeConst.REP_START.getValue()}">出勤</label><br />
<input type="time" name="start" value="${report.start}">
<br /><br />

<label for="${AttributeConst.REP_GOAL.getValue()}">退勤</label><br />
<input type="time" name="goal" value="${report.goal}">
<br /><br />
